...
export const buildHtml = (aiData: any, clientData: any, officeData: any, signers: any[]) => {
  ...
  return `
    <div style="font-family: Arial, Helvetica, sans-serif; font-size: 12pt; color: #000; line-height: 1.5;">
      
      ${headerHtml}

      <p style="font-weight: bold; text-transform: uppercase; margin-bottom: 20px;">
        ${getJurisdictionHeader(aiData, sanitizeCityUf(aiData.end_cidade_uf) || 'COMPETENTE')}
      </p>
